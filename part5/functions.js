...
/*
2. Create a function named `orderTea` taht takes one parameter,
...
3. Write an arrow function named `calculateTotal` that takes
   two parameters: `quantity` and `price`. the function 
...
4. Write a function named `processTeaOrder` that takes 
   another function, `makeTea`, as a parameter and call 
   it with the argument `"earl grey"`.
