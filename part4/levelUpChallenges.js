...
1. Write a `for` loop that loops through the array 
   `["green tea", "black tea", "chai", "oolong tea"]` and stores 
...
/*
2. Write a `for` loop that loops through the arrays
...
5. Use a `for-in` loop to loop through an object
   containing city populations.
     ...
     found and store all previous cities populations in 
     a new object named `cityPopulations`.
...
/*
6. Use a `for-in` loop to loop throughh an object
   containing city populations.
...
7. Write a `forEach` loop that iterates through the array
   `["earl grey", "green tea", "chai", "oolong tea"]`.
      ...
      Stops the loop when `"Chai"` is found, and store all 
...
/*
8. Write a `foeEach` loop that iterates through the array 
   `["Berlin", "Tokyo", "Sydney", "Paris"]`.
     
      Skip `"Sydeny"` and store the other cities in a new
...
/*
9. Write a `for` loop that ierates through the array
   `[2, 5, 7, 9]`.
...
/*
10. Use a `for-of` loop to  iterate the array 
